...
public:
  ...
  {
    pub_ = nh_.advertise<PointCloud>("PASS_OUT",1);
  ...
  void dynReconfCallback(pcl_helpers::passthrough_filter_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  ros::Subscriber sub_;
  ros::Publisher pub_;
  dynamic_reconfigure::Server<pcl_helpers::passthrough_filter_nodeConfig> config_server_;
